...
if (process.env.NODE_ENV !== 'production') {
  var getStackAddendumByID = require('./ReactGlobalSharedState').ReactComponentTreeHook.getStackAddendumByID;
}
...
var ReactDOMInput = {
  ...
  mountWrapper: function (inst, props) {
    if (process.env.NODE_ENV !== 'production') {
      ...
      ReactControlledValuePropTypes.checkPropTypes('input', props, function () {
